...
export interface ModuleSlide {
  id: string;
  slideTag: string; // e.g. "FI MODÜLÜ — 1/2", "GEÇİŞ STRATEJİSİ"
...
export class ModullerService {
  private modulesList = signal<ModuleItem[]>([
    ...
    },
    {
      ...
      key: 'co-modulu',
      name: 'CO Modülü',
      description: 'Maliyet Muhasebesi, kâr merkezi, masraf yerleri, doğrulama ve dönem sonu',
      icon: 'pie-chart',
      slides: [
        {
          id: 'co-1',
    ...
    },
    {
      ...
      description: 'S/4HANA geçiş stratejisi, geçiş modelleri (Greenfield, Selective, Brownfield) ve sonuç analizi',
      icon: 'shuffle',
      slides: [
        {
          id: 'gm-1',
          slideTag: 'GEÇİŞ STRATEJİSİ',
          mainTitle: 'Geçiş Modelleri',
          cards: [
            {
              id: 'gm-c1',
    ...
    },
    {
      ...
      description: 'S/4HANA geçiş stratejisi, dönüşüm metodolojisi karşılaştırması ve tahmini süreler',
      icon: 'map',
      slides: [
        {
          id: 'yh-1',
